                ...
                <div class="col-md-12 mb-5">
                    <div class="card border rounded p-4 p-sm-5 wow fadeInUp" data-wow-delay="0.5s">
                        <center>
                            ...
                            <br><br>
                            <div>
                                <p>URL untuk dibagikan: <strong>{{ Request::url() }}</strong></p>
                            </div>
                            <div class="mb-3">
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(Request::url()) }}"
                                    target="_blank" class="btn btn-primary">Bagikan di Facebook</a>
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(Request::url()) }}&text={{ urlencode($row->judul) }}"
                                    target="_blank" class="btn btn-info">Bagikan di Twitter</a>
                                <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(Request::url()) }}&title={{ urlencode($row->judul) }}&summary={{ urlencode(Str::limit($row->isiartikel, 100)) }}"
                                    target="_blank" class="btn btn-success">Bagikan di LinkedIn</a>
                                <a href="https://www.instagram.com/?url={{ urlencode(Request::url()) }}" target="_blank"
                                    class="btn btn-danger">Bagikan di Instagram</a>
                            </div>
                        </center>
                        <br>
                        <div class="row g-3">
                            <div class="col-md-12">
                                <span style="text-align: justify" class="mt-2 text-dark">{!! $row->isiartikel !!}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-5">
                        <div class="card-body">
                            ...
                            @foreach ($comments as $comment)
                                <div class="mb-3">
                                    <p class="font-weight-bold">{{ $comment->komentar }}</p>
